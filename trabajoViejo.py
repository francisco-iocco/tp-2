'''Lucas Michelini, Francisco Iocco, Sebastian Gonzalez, Joaquin Benitez'''
import random
import os
...
datosPersonales = [["Lucas Michelini","2005-06-04","M","Rellenar","Progamacion competitiva,gimanasio,leer"],
                   ...
                   ["Sebastian Gonzalez","14","M","Rellenar","Rellenar"],
...
arConsole()
                ...
                match int(opc)def subMenu1Mod(usuario,moderadorIngreso):
    clearConsole()
    opc1 = ""
    while(opc1 != "b"):
